...
export default function AboutSection() {
  return (
    <section className='sm:flex px-[5%] sm:px-[10%] gap-4 mb-10'>
      <section className='sm:max-w-[50%]'>
        <h2 className='font-bold text-[2rem] mb-[40px] font-[sans]'>About Us</h2>
      ...
      <section className='border flex sm:flex-col mx-auto lg:flex-row gap-3 sm:w-[50%] max-w-[400px] lg:max-w-[430px] px-[5%] sm:py-[4%]'>
        <div className='flex grow relative max-w-[200px] min-w-[170px]  sm:w-[50%] sm:items-center'>
          <Image src={AboutImg1} width='312' height='453' alt='About section Image 1' className='w-full h-auto max-w-[200px] sm:w' />
          <Image src={AboutImg2} width='150' height='189' alt='About section Image 1' className='absolute top-1/4 right-[-28%] w-[45%] max-w-[90px] h-auto' />
        </div>
