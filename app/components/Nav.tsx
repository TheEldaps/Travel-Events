...
export default function Nav() {
  ...
  return (
    <header className={`px-[5%] sm:px-[10%] py-1 w-full bg-white pt-2.5 z-1 sticky top-0 `}>
      <nav className="flex justify-between items-center  mb-2.5">
        ...
        <button onClick={handleClick} className="block sm:hidden">
          <div className="p-[5px] flex flex-col gap-1 text-[1.5rem] hover:cursor-pointer  hover:bg-[#3232324f] ">
            {navState ? (
              '✕'
            ) : (
              <>
