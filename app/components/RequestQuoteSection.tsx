...
export default function RequestQuoteSection() {
    return (
        <section className='px-[5%] md:px-[10%] pt-10 border   '>
            <section className='mx-auto md:bg-[url("/RequestQuoteBgImage.png")] bg-no-repeat bg-[position:center_bottom] bg-[length:80%_auto]
 bg-contain'>
                ...
                <form action="" className='p-[5%] mx-auto shadow-2xl bg-[white]  w-full md:w-[60%] rounded-xl'>
                    ...
                    <button className=' block w-full text-white py-2 rounded-lg bg-black '>Submit </button>
                </form>
            </section>
